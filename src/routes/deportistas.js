...
router.post(
  ...
  [
    ...
    check("sexo", "El sexo debe ser MASCULINO, FEMENINO u OTRO").isIn([
      "Masculino",
      "Femenino",
      "Otro",
    ]),
    check("ciudad", "El nombre o el ID de la ciudad es obligatorio")
      .not()
      .isEmpty(),
...
router.put(
  ...
  [
    ...
    check("sexo", "El sexo debe ser MASCULINO, FEMENINO u OTRO")
      .optional()
