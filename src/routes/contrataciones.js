...
router.get(
  ...
  [
    check("deportistaID", "El ID del deportista es obligatorio")
      .not()
      .isEmpty(),
...
router.put(
  ...
  [
    ...
    check("valor_contrato", "El valor del contrato debe ser un número positivo")
      .optional()
      .isFloat({ gt: 0 }),
...
router.delete(
  "/:contratoID",
  [
    check("contratoID", "El ID de la contratación es obligatorio")
      .not()
      .isEmpty(),
    check("contratoID").custom(existeContratacionPorID),
    validarCampos,
