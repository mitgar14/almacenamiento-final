...
const obtenerEquipoPorID = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al obtener el equipo", detalle: error.message });
  }
};
...
const obtenerEquiposPorPais = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        error: "Error al obtener los equipos por país",
...
const obtenerEquiposPorDeporte = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({
        error: "Error al obtener los equipos por deporte",
        detalle: error.message,
      });
  }
};
...
const crearEquipo = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al crear el equipo", detalle: error.message });
  }
};
...
const actualizarEquipo = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al actualizar el equipo", detalle: error.message });
  }
};
...
const eliminarEquipo = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ error: "Error al eliminar el equipo", detalle: error.message });
  }
};
